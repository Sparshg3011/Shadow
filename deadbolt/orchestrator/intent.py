...
# `or` (not getenv default) so an empty ASI_ONE_API_KEY= in .env still boots —
# the client constructs, calls just 401 until a real key is set.
client = OpenAI(
    base_url="https://api.asi1.ai/v1",
    api_key=os.getenv("ASI_ONE_API_KEY") or "INSERT_YOUR_API_KEY_HERE",
)
